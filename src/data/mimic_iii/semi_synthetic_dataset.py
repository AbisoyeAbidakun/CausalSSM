        ...
        for i, patient_ix in enumerate(self.all_vitals.index.levels[0][:n_patients]):
            ...
            for outcome in self.synthetic_outcomes:
                ...
                if mode == 'factual':
                    ...
                    color = ax[ax_ind + 3]._get_lines.get_next_color()  # prop_cycler removed in mpl 3.5
...
class MIMIC3SyntheticDatasetCollection(SyntheticDatasetCollection):
    ...
    def __init__(self,
        ...
        try:
            ...
            _log.getLogger(__name__).warning(f'plot_timeseries (train) skipped: {_plot_err}')
        ...
        except Exception as _plot_err:  # non-fatal: display may be unavailable on headless servers
            import logging as _log
            _log.getLogger(__name__).warning(f'plot_timeseries skipped: {_plot_err}')
        ...
        try:
            ...
            import logging as _log
            _log.getLogger(__name__).warning(f'plot_timeseries (test_cf_treatment_seq) skipped: {_plot_err}')
