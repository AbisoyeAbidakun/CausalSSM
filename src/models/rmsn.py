...
One of the four baselines reported in the paper Uses inverse-probability-of-treatment
weighting (IPTW) from a separately trained propensity network, rather than
adversarial balancing, to deconfound an LSTM encoder-decoder — contrasting
explicit propensity-based deconfounding against the domain-confusion
approach shared by CT and the proposed CSSD-family models.
"""
