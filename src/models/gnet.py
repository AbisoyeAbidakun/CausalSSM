"""
GNet — G-computation Network.

One of the four baselines reported in the paper. An LSTM-based factored-conditional
g-computation estimator — relies on the statistical g-formula rather than
adversarial balancing or propensity weighting, providing a reference point
from a structurally different deconfounding family.
"""
