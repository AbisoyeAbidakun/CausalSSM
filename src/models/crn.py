...
Bica, Alaa, Jordon & van der Schaar (2020). "Estimating Counterfactual
Treatment Outcomes over Time Through Adversarially Balanced
Representations." ICLR 2020.

One of the four baselines reported in the paper "Causal State-Space Model
for Causal Inference: Estimating Longitudinal Individual Treatment
Effects". A GRU encoder-decoder trained with
gradient-reversal adversarial balancing (two-phase: CRNEncoder then
CRNDecoder, via runnables/train_enc_dec.py), providing a reference point
for the SSM/attention encoder choice against a recurrent baseline.
"""
